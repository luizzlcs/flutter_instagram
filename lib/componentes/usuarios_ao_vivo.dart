...
class UsuariosAoVivo extends StatelessWidget {
  const UsuariosAoVivo({Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: const RadialGradient(
                      ...
                      radius: 1.3,
                      colors: <Color>[
                        Color.fromARGB(255, 113, 41, 161), // yellow sun
                        Color.fromARGB(255, 233, 150, 94), // blue sky
                      ],
